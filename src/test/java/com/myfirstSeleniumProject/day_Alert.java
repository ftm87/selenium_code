...
public class day_Alert extends TestBase {
...
//    sendKeysAlert()=> click on the third alert, verify text "I am a JS prompt",
        ...
        WebElement allertButton=driver.findElement(By.xpath("//button[@onclick='jsPrompt()']"));

        allertButton.click();



        //vrify text"I am a JS prompt",

        Assertions.assertTrue(driver.switchTo().alert().getText().contains("I am a JS prompt"));

        //    type "Hello World", click OK

        driver.switchTo().alert().sendKeys("Turkiye");
